/*
	In this program we will update the game screen using onDraw function.All the 
	sharedpreferences values are used for assigning different values in game. We update the gameloop 
	according to the user's movement.We also minimize power consumption of the accelorometer when the game
	is out of scope or paused.
...
public class BarrelRaceActivity extends Activity implements Callback,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sensorRegister = mSensorManager.registerListener(this, mAccel,
	...
	protected void onResume() {
		...
		builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int id) {
				model.pause = false;
				mSensorManager.registerListener(BarrelRaceActivity.this,
