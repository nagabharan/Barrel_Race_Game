/*
	In this program we can change the various settings like size of barrel,color of the barrel,horse and background color.
	All these preferences are stored in the SharedPreferences.
