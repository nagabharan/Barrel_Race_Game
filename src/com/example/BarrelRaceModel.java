/*
	This program defines the model used for designing the game.Here we use the accelerometer and vibrator to simulate
	the horse motion in the surfaceview.The physics function is used for moving the horse and the iscompletedcircle function 
	is used to check if the user makes a complete circle around each barrel.
